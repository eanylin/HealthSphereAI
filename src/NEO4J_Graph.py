...
class Graph:
    ...
    def cypher_transaction(self, cypher):
        driver = GraphDatabase.driver(self._url, auth=(self._username, self._password), database=self._database,connection_acquisition_timeout=300,connection_timeout=300)
        values = []
